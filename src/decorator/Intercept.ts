 ...
 */
export function Intercept(...interceptors: Array<Function>): Function;

/**
 * Specifies a given interceptor middleware or interceptor function to be used for controller or controller action.
 * Must be set to controller action or controller class.
 */
export function Intercept(...interceptors: Array<(action: Action, result: any) => any>): Function;

/**
 * Specifies a given interceptor middleware or interceptor function to be used for controller or controller action.
 * Must be set to controller action or controller class.
 */
export function Intercept(...interceptors: Array<Function|((action: Action, result: any) => any)>): Function {
