...
describe('action parameters', () => {
    ...
    before(() => {
        ...
        class UserActionParamsController {
            ...
            @Get('/photos')
            public getPhotos(@QueryParam('sortBy') sortBy: string,
            ...
            @Get('/posts')
            public getPosts(@HeaderParam('token') token: string,
            ...
            @Get('/questions')
            public getQuestions(@CookieParam('token') token: string,
            ...
            public getUserPhoto(@Param('firstId') firstId: number,
        ...
        class SecondUserActionParamsController {
            ...
            @Post('/users')
            public postUser(@BodyParam('name') name: string,
            ...
            public postUserWithRequired(@BodyParam('name', { required: true }) name: string,
