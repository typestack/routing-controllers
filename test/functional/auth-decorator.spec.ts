...
describe('Controller responds with value when Authorization succeeds (async)', () => {
  ...
  it('without roles', () => {
    expect.assertions(2);
    return axios.get('/auth1').then((response: AxiosResponse) => {
  ...
  it('with roles', () => {
    expect.assertions(2);
    return axios.get('/auth2').then((response: AxiosResponse) => {
      expect(response.status).toEqual(HttpStatusCodes.OK);
  ...
  it('async', () => {
    expect.assertions(2);
    return axios.get('/auth3').then((response: AxiosResponse) => {
      expect(response.status).toEqual(HttpStatusCodes.OK);
...
describe('Authorized Decorators Http Status Code', () => {
  ...
  it('without roles', () => {
    expect.assertions(1);
    return axios.get('/auth1').catch((error: AxiosError) => {
  ...
  it('with roles', () => {
    expect.assertions(1);
    return axios.get('/auth2').catch((error: AxiosError) => {
